...
const footerNavigation = {
  resources: [
    { name: "Biblical Counseling", href: "/biblical-counseling" },
    { name: "Event - ACBC Certified Celebration", href: "/acbc-celebration" },
    // { name: "ACBC Conference and Award", href: "/acbc-certification" },
    // { name: "Blog", href: "/posts" },
    // { name: "Speaking Schedule", href: "/" },
  ],
  about: [
  ...
  training: [
    ...
    { name: "PBCM 2021 Vision", href: "/training/pbcm-2021-vision" },
    { name: "Cancer Care Ministry", href: "/training/cancer-care" },
    { name: "Titus 2 - Womens Ministry", href: "/training/titus-2" },
  ],
  social: [
    {
      name: "Facebook",
        ...
        <div className="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
          ...
          <div className="flex flex-col justify-around">
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2021 Peninsula Biblical Counseling Ministries: Charleston,
