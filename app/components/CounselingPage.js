          ...
          <div className="relative px-4 sm:px-6 lg:px-8">
            <div className="text-lg max-w-prose mx-auto">
              ...
              <p className="mt-8 text-l font-semibold text-blue-500 leading-8">
                <a
                  href="https://www.csmedia1.com/peninsulabiblicalcounselingministries.org/pc-course-description.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:underline"
                >
                  Pastoral Counseling Course Outline
                </a>
              </p>
              <h1>
              ...
              <p className="mt-6 text-l font-semibold text-blue-500 leading-8">
                <a
                  ...
                  className="hover:underline"
                >
                  PBCM Frequently Asked Questiosn
                </a>
              </p>
              <p className="mt-4 text-l font-semibold text-blue-500 leading-8">
                <a
                  href="https://www.csmedia1.com/peninsulabiblicalcounselingministries.org/consent-to-counsel-form-updated-08920.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:underline"
                >
              ...
              <p className="mt-4 text-l font-semibold text-blue-500 leading-8">
                <a
                  href="https://www.csmedia1.com/peninsulabiblicalcounselingministries.org/counseling-pdi.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:underline"
                >
